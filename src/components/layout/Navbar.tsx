      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden xl:flex items-center space-x-1">
            ...
            {/* Admin Portal Nav Item (Strictly visible only if role === 'admin') */}
            {role === 'admin' && (
              <button
                id="nav-link-admin"
                onClick={() => setCurrentView('admin')}
                className={`relative flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg text-xs font-bold transition cursor-pointer ${
