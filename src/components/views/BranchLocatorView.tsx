    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-4 py-2.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold transition border border-indigo-200"
        >
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start justify-between gap-4">
                ...
                <a
                  ...
                  className="flex items-center space-x-1.5 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-xs shrink-0"
                >
                  <Navigation className="w-3.5 h-3.5" />
              ...
              <div className="space-y-2 text-xs text-slate-600 pt-2 border-t border-slate-100">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Phone: <a href={`tel:${selectedBranch.phone}`} className="text-indigo-600 font-semibold">{selectedBranch.phone}</a></span>
                </div>

                <div className="flex items-center space-x-2">
                  <Mail className="w-4 h-4 text-indigo-600 shrink-0" />
                  <span>Email: <a href={`mailto:${selectedBranch.email}`} className="text-indigo-600">{selectedBranch.email}</a></span>
                </div>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-600">
                <span className="font-bold text-slate-800">Assigned Nodal Officer: </span>
