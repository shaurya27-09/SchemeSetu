        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/80 px-2.5 py-1 rounded-full border border-indigo-200 dark:border-indigo-800">
                Deterministic Eligibility Questionnaire
              </span>
              <span className="inline-flex items-center space-x-1 text-[11px] font-semibold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/80 px-2.5 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                <span>Live Rule Engine Ready</span>
              </span>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Quick Presets:</span>
            <button
              type="button"
              onClick={() => applyPreset('sc_woman')}
              className="text-xs px-2.5 py-1 rounded-lg bg-pink-50 dark:bg-pink-950/60 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-800 hover:bg-pink-100 dark:hover:bg-pink-900/40 font-medium cursor-pointer"
            ...
            <button
              ...
              className="text-xs px-2.5 py-1 rounded-lg bg-amber-50 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900/40 font-medium cursor-pointer"
            ...
            <button
              ...
              className="text-xs px-2.5 py-1 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 font-medium cursor-pointer"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm font-semibold"
                />
                <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-1 flex items-center space-x-1">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm font-medium"
                >
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[10px] text-emerald-700 dark:text-emerald-400 font-semibold bg-emerald-50 dark:bg-emerald-950/60 px-1.5 py-0.5 rounded border border-emerald-200 dark:border-emerald-800">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm placeholder:text-slate-400"
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(['rural', 'semi-urban', 'urban'] as LocationType[]).map((loc) => (
                    <button
                      ...
                      className={`py-2 px-3 text-xs font-semibold rounded-xl border capitalize text-center transition cursor-pointer ${
                        profile.locationType === loc
                          ? 'bg-indigo-50 dark:bg-indigo-950/60 border-indigo-600 dark:border-indigo-500 text-indigo-700 dark:text-indigo-300 shadow-xs'
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                />
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white">Scheduled Caste (SC)</h4>
              ...
              >
                ...
                />
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white">Other Backward Classes (OBC - Non-Creamy Layer)</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">
              ...
              >
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white">Safai Karamchari / Sanitation Worker & Dependents</h4>
              ...
              >
                ...
                />
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white">De-Notified, Nomadic and Semi-Nomadic Tribes (DNT/NT)</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">
            ...
            <div className="p-3.5 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-300 flex items-start space-x-2">
              <HelpCircle className="w-4 h-4 text-indigo-500 dark:text-indigo-400 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold text-slate-700 dark:text-slate-200">Why is affirmative category required? </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 dark:text-slate-500 text-sm font-bold">
                    ₹
                  </span>
                  <input
                    id="input-income"
                    ...
                    className="w-full pl-8 pr-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm font-semibold"
                  />
                </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            ...
            <div className="space-y-6">
                ...
                {profile.technicalTraining && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-xs placeholder:text-slate-400"
                    />
                  </div>
                )}
              </div>
              ...
              {/* Review Summary Box */}
              <div className="p-4 bg-indigo-50/80 dark:bg-indigo-950/50 rounded-xl border border-indigo-200 dark:border-indigo-800/60">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                  <div>
                    ...
                    <span className="font-bold text-slate-800 dark:text-slate-200">{profile.category}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 dark:text-slate-400 block">Family Income:</span>
                    <span className="font-bold text-slate-800 dark:text-slate-200">{formatIndianCurrency(profile.annualFamilyIncome, true)}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 dark:text-slate-400 block">Project Cost:</span>
                    <span className="font-bold text-slate-800 dark:text-slate-200">{formatIndianCurrency(profile.projectCost, true)}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 dark:text-slate-400 block">Desired Loan:</span>
                    <span className="font-bold text-slate-800 dark:text-slate-200">{formatIndianCurrency(profile.requestedLoanAmount, true)}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <div>
            {currentStep > 1 && (
              <button
                ...
                type="button"
                onClick={handleBack}
                className="flex items-center space-x-1.5 px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 font-semibold text-xs transition cursor-pointer"
              >
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="text-xs text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 flex items-center space-x-1 px-3 py-2 cursor-pointer"
            ...
            <button
              ...
              type="button"
              onClick={handleNext}
              className="flex items-center space-x-2 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white px-6 py-2.5 rounded-xl font-bold text-sm shadow-md shadow-indigo-200 dark:shadow-none transition transform hover:-translate-y-0.5 cursor-pointer"
            >
